...
ORDER BY
    4 DESC
LIMIT 500) SELECT SUM(bi_ta_dw_susc_activas_diarias_total_cantidad_de_clientes_1) AS T FROM GR"""
     # Obtener los resultados
        ...
        rs_suscripcionesClaroTV = row[0]
        # Mostrar el valor en el formato deseado
        print(f"Suscripciones activas ClaroTV Go (BI): {rs_suscripcionesClaroTV}")
